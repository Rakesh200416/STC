...
```env
MONGO_URI=mongodb+srv://rakiravi:Raki123ravi@cluster0.b7m3dux.mongodb.net/smarttestcenter?retryWrites=true&w=majority
...
1. **Create a GitHub Repository**
   ...
   - Make sure both backend and frontend directories are at the root level
...
5. **Configure Routes**
   - In your frontend service settings, add a route:
     - Source: `/api/**`
     - Destination: `https://your-backend-service.onrender.com/**`

6. **Update CORS Settings**
   - In your backend server.js, update the CORS configuration to allow your frontend URL:
   ```javascript
