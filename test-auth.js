...
const testAuth = async () => {
  try {
    ...
    const response1 = await axios.post('https://smart-test-center.onrender.com/api/tests', {
      name: 'Test',
  ...
  try {
    ...
    const response2 = await axios.post('https://smart-test-center.onrender.com/api/tests',  
      {
        name: 'Test',
        questions: [{ question: 'Test?', options: ['A', 'B'], correctOption: 'A', marks: 1 }]
      },
